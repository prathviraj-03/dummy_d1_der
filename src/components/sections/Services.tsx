                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="w-10 h-10 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-forest/5 flex items-center justify-center mb-4 md:mb-8 group-hover:bg-forest transition-colors duration-500 shrink-0">
                      <Icon className="w-5 h-5 md:w-8 md:h-8 text-[#1A1A1A] group-hover:text-gold transition-colors duration-500" strokeWidth={1.5} />
                    </div>

                    <h3 className="text-base sm:text-lg md:text-2xl font-bold text-[#1A1A1A] mb-2 md:mb-4 tracking-tight group-hover:text-forest-mid transition-colors">
                      {service.title}
                    </h3>
